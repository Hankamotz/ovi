...
{for(var i = 0, len = gdjs.saltoCode.GDtapObjects1.length ;i < len;++i) {
    ...
    gdjs.saltoCode.GDinstructionObjects1[i].setOpacity(gdjs.saltoCode.GDinstructionObjects1[i].getOpacity() - (128*gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene)));
}
}}
