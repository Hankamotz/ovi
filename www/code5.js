...
{for(var i = 0, len = gdjs.zeruaCode.GDtapObjects1.length ;i < len;++i) {
    ...
    gdjs.zeruaCode.GDinstructionObjects1[i].setOpacity(gdjs.zeruaCode.GDinstructionObjects1[i].getOpacity() - (128*gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene)));
}
}}
