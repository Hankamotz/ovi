...
{for(var i = 0, len = gdjs.rockpaperCode.GDtapObjects1.length ;i < len;++i) {
    ...
    gdjs.rockpaperCode.GDinstructionObjects1[i].setOpacity(gdjs.rockpaperCode.GDinstructionObjects1[i].getOpacity() - (128*gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene)));
}
}}
...
{for(var i = 0, len = gdjs.rockpaperCode.GDpapericonObjects1.length ;i < len;++i) {
    ...
    gdjs.rockpaperCode.GDhandObjects1[i].addForceTowardPosition(406, 680, 800, 0);
}
}}
...
for(var i = 0, k = 0, l = gdjs.rockpaperCode.GDhandObjects1.length;i<l;++i) {
    if ( gdjs.rockpaperCode.GDhandObjects1[i].getY() < 720 ) {
...
{for(var i = 0, len = gdjs.rockpaperCode.GDovihandObjects2.length ;i < len;++i) {
    ...
    gdjs.rockpaperCode.GDhandObjects2[i].setY(1400);
}
