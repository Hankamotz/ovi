...
{for(var i = 0, len = gdjs.crashCode.GDtapObjects1.length ;i < len;++i) {
    ...
    gdjs.crashCode.GDinstructionObjects1[i].setOpacity(gdjs.crashCode.GDinstructionObjects1[i].getOpacity() - (128*gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene)));
}
}}
