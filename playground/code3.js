...
{for(var i = 0, len = gdjs.txanponCode.GDtapObjects1.length ;i < len;++i) {
    ...
    gdjs.txanponCode.GDinstructionObjects1[i].setOpacity(0);
}
}}
...
gdjs.txanponCode.condition0IsTrue_0.val = false;
{
gdjs.txanponCode.condition0IsTrue_0.val = gdjs.evtTools.runtimeScene.timerElapsedTime(runtimeScene, 34, "music");
}if (gdjs.txanponCode.condition0IsTrue_0.val) {
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, context.clearEventsObjectsMap().addObjectsToEventsMap("basoa", gdjs.txanponCode.GDbasoaObjects1).getEventsObjectsMap(), 800, 860, "juego");
}}
