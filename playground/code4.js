...
}{gdjs.evtTools.sound.playMusicOnChannel(runtimeScene, "mixdown.ogg", 1, false, 100, 1);
...
gdjs.saltoCode.condition0IsTrue_0.val = false;
{
gdjs.saltoCode.condition0IsTrue_0.val = gdjs.evtTools.runtimeScene.timerElapsedTime(runtimeScene, 31, "music");
}if (gdjs.saltoCode.condition0IsTrue_0.val) {
{gdjs.evtTools.sound.playMusicOnChannel(runtimeScene, "mixdown.ogg", 1, false, 100, 1);
...
gdjs.saltoCode.condition0IsTrue_0.val = false;
{
gdjs.saltoCode.condition0IsTrue_0.val = gdjs.evtTools.input.getMouseX(runtimeScene, "", 0) < 350;
}if (gdjs.saltoCode.condition0IsTrue_0.val) {
...
{
for(var i = 0, k = 0, l = gdjs.saltoCode.GDarraultzObjects4.length;i<l;++i) {
    if ( !(gdjs.saltoCode.GDarraultzObjects4[i].getX() >= 610) ) {
        gdjs.saltoCode.condition0IsTrue_0.val = true;
        gdjs.saltoCode.GDarraultzObjects4[k] = gdjs.saltoCode.GDarraultzObjects4[i];
        ++k;
    }
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, context.clearEventsObjectsMap().addObjectsToEventsMap("linea", gdjs.saltoCode.GDlineaObjects1).getEventsObjectsMap(), 260+gdjs.random(260), 1230, "");
}}
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, context.clearEventsObjectsMap().addObjectsToEventsMap("lineabi", gdjs.saltoCode.GDlineabiObjects2).getEventsObjectsMap(), (( gdjs.saltoCode.GDlineaObjects2.length === 0 ) ? 0 :gdjs.saltoCode.GDlineaObjects2[0].getPointX(""))-580, 1230, "");
}}
...
gdjs.saltoCode.GDlineaObjects2.length = k;}if (gdjs.saltoCode.condition0IsTrue_0.val) {
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, context.clearEventsObjectsMap().addObjectsToEventsMap("linea", gdjs.saltoCode.GDlineaObjects2).getEventsObjectsMap(), 260+gdjs.random(260), 1230, "");
}}
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, context.clearEventsObjectsMap().addObjectsToEventsMap("lineabi", gdjs.saltoCode.GDlineabiObjects1).getEventsObjectsMap(), (( gdjs.saltoCode.GDlineaObjects1.length === 0 ) ? 0 :gdjs.saltoCode.GDlineaObjects1[0].getPointX(""))-580, 1230, "");
