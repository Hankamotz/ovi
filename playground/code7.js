...
gdjs.crashCode.condition0IsTrue_0.val = false;
{
gdjs.crashCode.condition0IsTrue_0.val = gdjs.evtTools.runtimeScene.timerElapsedTime(runtimeScene, 31, "music");
}if (gdjs.crashCode.condition0IsTrue_0.val) {
{gdjs.evtTools.sound.playMusicOnChannel(runtimeScene, "mixdown.ogg", 1, false, 100, 1);
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, context.clearEventsObjectsMap().addObjectsToEventsMap("egg", gdjs.crashCode.GDeggObjects2).getEventsObjectsMap(), 600 -gdjs.random(600), 920 -gdjs.random(920), "");
}}
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, context.clearEventsObjectsMap().addObjectsToEventsMap("egg", gdjs.crashCode.GDeggObjects2).getEventsObjectsMap(), 600 -gdjs.random(600), 920 -gdjs.random(920), "");
}{gdjs.evtTools.object.createObjectOnScene(runtimeScene, context.clearEventsObjectsMap().addObjectsToEventsMap("kactus", gdjs.crashCode.GDkactusObjects2).getEventsObjectsMap(), 600 -gdjs.random(600), 920 -gdjs.random(920), "");
}}
