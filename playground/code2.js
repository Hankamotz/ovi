...
}{gdjs.evtTools.sound.playMusicOnChannel(runtimeScene, "funk.ogg", 1, false, 100, 1);
}}
...
gdjs.zeruaCode.condition0IsTrue_0.val = false;
{
gdjs.zeruaCode.condition0IsTrue_0.val = gdjs.evtTools.runtimeScene.timerElapsedTime(runtimeScene, 34, "music");
}if (gdjs.zeruaCode.condition0IsTrue_0.val) {
{gdjs.evtTools.sound.playMusicOnChannel(runtimeScene, "funk.ogg", 1, false, 100, 1);
...
gdjs.zeruaCode.condition0IsTrue_0.val = false;
{
gdjs.zeruaCode.condition0IsTrue_0.val = gdjs.evtTools.input.getMouseX(runtimeScene, "", 0) < 350;
}if (gdjs.zeruaCode.condition0IsTrue_0.val) {
...
{
for(var i = 0, k = 0, l = gdjs.zeruaCode.GDparachuteObjects4.length;i<l;++i) {
    if ( !(gdjs.zeruaCode.GDparachuteObjects4[i].getX() >= 610) ) {
        gdjs.zeruaCode.condition0IsTrue_0.val = true;
        gdjs.zeruaCode.GDparachuteObjects4[k] = gdjs.zeruaCode.GDparachuteObjects4[i];
        ++k;
    }
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, context.clearEventsObjectsMap().addObjectsToEventsMap("cloud", gdjs.zeruaCode.GDcloudObjects1).getEventsObjectsMap(), 680-gdjs.random(660), 1282, "");
}}
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, context.clearEventsObjectsMap().addObjectsToEventsMap("cloud", gdjs.zeruaCode.GDcloudObjects2).getEventsObjectsMap(), 680-gdjs.random(660), 1282, "");
}}
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, context.clearEventsObjectsMap().addObjectsToEventsMap("txanpon", gdjs.zeruaCode.GDtxanponObjects1).getEventsObjectsMap(), 680-gdjs.random(660), 1550, "");
}}
